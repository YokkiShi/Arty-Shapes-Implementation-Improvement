...
partShapes = {'robustCH', 'robustCH', 'robustCH', 'rect', 'rect',...
              'robustCH', 'tri', 'robustCH', 'robustCH', 'robustCH',...
              'sup', 'circ', 'tri', 'robustCH','robustCH',...
              'rect', 'tri', 'rect', 'rect','robustCH',...
              'circ', 'robustCH', 'robustCH', 'tri','sup' };
